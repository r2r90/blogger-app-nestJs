...
describe('AppController (e2e)', () => {
  ...
  it('check login & refresh flow', async () => {
    ...
    console.log(refreshTokenUponLogin, 'cookies');
    console.log(loginResponce.body.accessToken, " accessToken")
    await delay(20000)
    ...
    const secondRefreshTokenUponLogin = secondLoginResponce.headers['set-cookie']
